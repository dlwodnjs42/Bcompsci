...
class Move {
    ...
    /** Gets the move.
     * @param col0 - initial col.
     * @param row0 - initial row.
     * @param col1 - final col.
     * @param row1 - final row.
     * @param moved - moved.
     * @param replaced - replaced.
     * @return Move.
     */
    public static Move movegetter(int col0, int row0, int col1, int row1,
                            Piece moved, Piece replaced) {
        Move t = new Move(col0, row0, col1, row1, moved, replaced);
        return t;
    }
