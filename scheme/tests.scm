...
;Problem 7
(begin (+ 500 321412421) (- 6 6))
;expect 0

(begin (+ 25 35) (quote 1414))
;expect 1414

(begin (quote (car (quote (a b c)))))
;expect (car (quote (a b c)))
...
(define a (mu (x) (display 'this_is_unnatural_sir_james_the_) (* x (- y z))))
(define b (lambda (x y z) (a x)))
(b 2 4 3)
;expect this_is_unnatural_sir_james_the_2

;problem 22 EC
(define (subtract n total)
  (if (zero? n) total
    (subtract (- n 1) (- n total))))
(subtract 13 2)
;expect 5
...
;DONEEEEEEE
;how to check the solutions/if the test is working: python3 scheme.py tests.scm
