...
def roll_dice(num_rolls, dice=six_sided):
    ...
    'still need to roll after getting 1; therefore temporary_result = 1'
    ...
    while k <= num_rolls:
        ...
        if curr_roll == 1:
            temporary_result = 1        
        k = k + 1
        total = total + curr_roll
    if temporary_result == 1:
        return 1
    else:
        return total
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if opponent_score <= 10:
        largest_number = opponent_score
    else:
        tenth_digit, ones_digit = opponent_score % 10, opponent_score // 10
        largest_number = max(tenth_digit, ones_digit) 
    if num_rolls == 0:
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while (score0 < goal and score1 < goal):
        if who == 0:
            scoreadd = take_turn (strategy0(score0,score1) , score1, select_dice(score0, score1))
            score0 = score0 + scoreadd
            totalscore = score0 + score1
            if is_prime(totalscore):
                if score0 > score1:
                    score0 = score0 + scoreadd
                if score1 > score0:
            ...
            scoreadd = take_turn (strategy1(score1,score0), score0, select_dice(score1, score0))
            score1 = score1 + scoreadd
            totalscore = score0 + score1
            if is_prime(totalscore):
                if score0 > score1:
